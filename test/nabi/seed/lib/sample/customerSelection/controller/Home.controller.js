sap.ui.define([
	"test/nabi/seed/lib/sample/customerSelection/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/m/MessageToast",
	"sap/ui/core/ComponentContainer",
	"sap/base/Log",
], function(BaseController, JSONModel, MessageToast, ComponentContainer, Log) {
	"use strict";

	return BaseController.extend("test.nabi.seed.lib.sample.customerSelection.controller.Home", {
