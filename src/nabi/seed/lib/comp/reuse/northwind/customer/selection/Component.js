sap.ui.define([
	...
	var Component = UIComponent.extend("nabi.seed.lib.comp.reuse.northwind.customer.selection.Component", {
	...
	Component.prototype._getCustomerSelectDialog = function () {
		if (!this._oTSD) {
			this._oTSD = sap.ui.xmlfragment(this.getId(), "nabi.seed.lib.comp.reuse.northwind.customer.selection.fragment.CustomerTableSelectDialog", this);
