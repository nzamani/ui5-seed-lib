sap.ui.define([
	...
	var Component = UIComponent.extend("nabi.seed.lib.comp.reuse.northwind.customer.selectionBtn.Component", {
	...
	Component.prototype.onCustomerSearch = function (oEvent) {
		...
		sQuery = jQuery.trim( oEvent.getParameter("value") );
	...
	Component.prototype._getCustomerSelectDialog = function () {
		if (!this._oTSD) {
			this._oTSD = sap.ui.xmlfragment(this.getId(), "nabi.seed.lib.comp.reuse.northwind.customer.selectionBtn.fragment.CustomerTableSelectDialog", this);
